"""Official validation plus exact V4/V3.1 identity preservation."""

from pathlib import Path
from typing import Any, Dict

from deep_oc_sort_3d.official_023_027.official_track1_validator import validate_official_track1
from deep_oc_sort_3d.v51_geometry_calibration_refit.v51_config import input_track1_path
...
def validate_v51_track1(
    path: Path, output_path: Path, config: Dict[str, Any], progress: bool = True,
) -> Dict[str, Any]:
    ...
    identity = {
        ...
        "input_unique_tracks": unique_track_count(baseline),
        "candidate_unique_tracks": unique_track_count(candidate),
    }
