"""Evaluate YOLO detections on internal train holdout scenes."""
...
def evaluate_yolo_internal_holdout(args: Any) -> None:
    """Evaluate internal holdout detections and save metrics."""
    ...
    print("Internal holdout metrics are diagnostic only, not an official score.")
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evaluate YOLO on internal holdout scenes.")
...
def main() -> None:
    ...
    evaluate_yolo_internal_holdout(args)
