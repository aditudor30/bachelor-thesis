"""Validate V5.1 variants and select a strict fit-train candidate."""
...
from deep_oc_sort_3d.v51_geometry_calibration_refit.v51_config import VARIANT_NAMES, load_v51_config, progress_default, variant_root
...
def main() -> None:
    ...
    for variant in variants:
        ...
        report_path = directory / "validation_summary.json"
        if report_path.exists() and args.skip_existing:
            ...
            report = validate_v51_track1(directory / "track1.txt", report_path, config, progress=progress)
