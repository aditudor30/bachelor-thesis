"""Collect final freeze v2 figures only."""
...
def main() -> None:
    ...
    summary = collect_final_freeze_v2_figures_from_config(args.config, show_progress=bool(args.progress), overwrite=bool(args.overwrite))
    print("figures: %s" % summary.get("num_figures"))
    print("output_root: %s" % output_root)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect final freeze v2 figures.")
